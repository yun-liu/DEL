...
class VOCSegDataLayer(caffe.Layer):
    ...
    def setup(self, bottom, top):
        ...
        split_f  = '{}/{}.lst'.format(self.voc_dir,
                self.split)
    ...
    def load_image(self, idx):
        ...
        img_path = '{}/Images/{}.jpg'.format(self.voc_dir, idx)
        #print idx
    ...
    def load_label(self, idx):
        ...
        """
        #im = Image.open('{}/groundTruth/{}.png'.format(self.voc_dir, idx))
        gt_path = '{}/groundTruth/{}.png'.format(self.voc_dir, idx)
        im = cv2.imread(gt_path, 0)
