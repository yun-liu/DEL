...
## added by pengtaojiang
TEST_SIMILARITY = .build_release/test/test_similarity_loss_layer.testbin
runtest_similarity: $(TEST_ALL_BIN)
	$(TOOL_BUILD_DIR)/caffe
	echo $(TEST_SIMILARITY)
	$(TEST_SIMILARITY) $(TEST_GPUID) --gtest_shuffle $(TEST_FILTER) 
